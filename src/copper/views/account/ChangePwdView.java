...
import copper.controllers.account.ChangePwdController;
    ...
    public Stage getWindow()
    {
        ...
        try
        {
            ...
            if(Configurations.getConfig("theme").equals("dark"))
            {
                ...
                getResource("/copper/views/account/ChangePwdViewDark.fxml"));
            }else
            {
                loader = new FXMLLoader(getClass().
                getResource("/copper/views/account/ChangePwdView.fxml"));
            }
            root = loader.load();

            ChangePwdController ctrl = loader.getController();
            ctrl.setData(window);
