...
public class SuccessView
{
    ...
    public SuccessView(String successMsg)
    {
    ...
    public void getWindow()
    {
        ...
        try
        {
            ...
            if(Configurations.getConfig("theme").equals("dark"))
            {
                ...
                getResource("/copper/views/dialogs/SuccessViewDark.fxml"));
            }else
            {
                loader = new FXMLLoader(getClass().
                getResource("/copper/views/dialogs/SuccessView.fxml"));
            }
            root = loader.load();

            BoxController ctrl = loader.getController();
            ctrl.setData(this.successMsg, window);
